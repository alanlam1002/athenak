...
# hohlraum test, -DPROBLEM=rad_hohlraum, on Sakura. Modeled on
# build_diffref_sakura.sh. Separate build directory from build_m1 since
# PROBLEM=rad_hohlraum is mutually exclusive with the M1 tests'
# built_in_pgens build.
...
BUILD_DIR=${ATHENAK_ROOT}/build_hohlraum
