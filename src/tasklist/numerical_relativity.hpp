...
enum TaskName {
  ...
  CFC_RescaleSrc,
  CFC_SolveLapse,
  CFC_RestPsi, CFC_SendPsi, CFC_RecvPsi, CFC_ProlongPsi, CFC_BCSPsi,
  CFC_RestAlphaPsi, CFC_SendAlphaPsi, CFC_RecvAlphaPsi, CFC_ProlongAlphaPsi,
  CFC_BCSAlphaPsi,
  CFC_BuildSrcBeta,
  CFC_RestPiEtaBeta, CFC_SendPiEtaBeta, CFC_RecvPiEtaBeta, CFC_ProlongPiEtaBeta,
  CFC_BCSPiEtaBeta,
  CFC_ReconstructBeta,
  CFC_AssembleFinal,
  CFC_RestADM, CFC_SendADM, CFC_RecvADM, CFC_ProlongADM, CFC_BCSADM,
