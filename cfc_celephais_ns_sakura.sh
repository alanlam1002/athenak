...
# the Celephais single-NS initial-data reader on Sakura, via the
# dyn_grmhd/celephais/celephais_ns problem generator (CFC variant -- no z4c
# involved). See cfc_celephais_bns_sakura.sh for the BNS counterpart; same
# toolchain/module set, only PROBLEM/BUILD_DIR differ.
...
BUILD_DIR=${ATHENAK_ROOT}/build_cfc_celephais_ns
...
cmake \
  ...
  -DPROBLEM=dyn_grmhd/celephais/celephais_ns \
