...
Mesh::Mesh(ParameterInput *pin) :
  ...
  // grid-geometry coordinate system (see coordinates/coord_general.hpp)
  coord_general = ParseCoordGeneral(pin);
  ...
  ValidateCoordGeneral();  // see coordinates/coord_general.cpp
